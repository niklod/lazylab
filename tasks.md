...
- [ ] Error text overflows modal border in merge confirmation
...
- [ ] Stray grey row at top of MRs list after close action
...
- [ ] Pressing `M` on MR list renders modal without Yes/No footer
